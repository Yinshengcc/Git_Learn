...
class SimpleSentimentAnalyzer:
    ...
    def preprocess_text(self, text):
        ...
        # Remove very short and common words that carry little sentiment.
...
def create_training_data():
    ...
    return [
        ...
        (
            "Brilliant performance! The acting was superb and the story captivating.",
            "positive",
        ),
        (
            "Fantastic film! Highly recommend to everyone. Best movie of the year!",
            "positive",
        ),
        ...
        (
            "Amazing! This film exceeded all my expectations. Truly remarkable.",
            "positive",
        ),
        ...
        (
            "Horrible! The worst movie I have ever seen. Extremely disappointing.",
            "negative",
        ),
        ...
        (
            "Terrible experience. Boring and poorly made. Don't waste your time.",
            "negative",
        ),
