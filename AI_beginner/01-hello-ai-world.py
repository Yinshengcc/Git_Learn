...
class SimpleAILearner:
    ...
    这是一个非常简单的人工智能，它可以学习线性关系。
    这展示了人工智能的基本概念：从数据中学习。
    """

    def __init__(self):
        # The "weight" is what our AI learns “权重”是我们的人工智能学习到的东西
        # It starts with a random guess 它从一个随机猜测开始
        self.weight = random.uniform(0, 5)
        self.learning_rate = 0.01  # How fast our AI learns 我们的人工智能学习速度有多快？
    ...
    def train(self, training_data, epochs=100):
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % 20 == 0:
                ...
                print(
                    f"Epoch {epoch + 1}/{epochs} - Average error: {avg_error:.4f} - Weight: {self.weight:.2f}"
                )
...
def main():
    ...
    for x in test_inputs:
        ...
        print(
            f"Input: {x:2d} | Prediction: {prediction:6.2f} | Actual: {actual:6.2f} | Difference: {abs(prediction - actual):.2f}"
        )
